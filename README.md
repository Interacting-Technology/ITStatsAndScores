...
- [x] 01. Reversed Table Form presentation (WDDWL) in SoccerCompetition AND SoccerTeam
- [x] 01. Jira (FRI-5865) - Fix for non scrollable fixture modules in iOS versions lower than 18.0 - https://livesport.atlassian.net/browse/FRI-5865
