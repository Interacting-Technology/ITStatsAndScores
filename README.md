...
- [x] Added public enum StatsAndScoresAccess.TypeOfSport
- [x] Added public enum StatsAndScoresAccess.TypeOfSport
...
## Search Page
- [x] Search for Competitions or Teams
...
- Dependency Rule -> Up to Next Major \<major.minor.patch> (example: 0.9.1)
